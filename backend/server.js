...
// Middleware
app.use(cors({
  origin: ["http://localhost:3000", "https://medix-9q3ospxi5-mohammadkaif-momins-projects.vercel.app", "https://medix-ofphvna4x-mohammadkaif-momins-projects.vercel.app", process.env.FRONTEND_URL || "*"], // Allow frontend origin
  credentials: true
}));
